	...
	if resp != nil {
		...
		for choicesCount, choicesItem := range resp.Choices {
			...
			if choicesItem.Logprobs == nil {
				...
				choices1.Logprobs = &tfTypes.Logprobs{}
				choices1.Logprobs.TextOffset = []types.Int64{}
				...
				choices1.Logprobs.TokenLogprobs = []types.Number{}
				...
				choices1.Logprobs.Tokens = []types.String{}
