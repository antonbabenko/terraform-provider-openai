...
import (
	...
	"github.com/antonbabenko/terraform-provider-openai/v2/internal/sdk/retry"
	"net/http"
	"time"
)
...
func New(opts ...SDKOption) *Oai {
	sdk := &Oai{
		sdkConfiguration: sdkConfiguration{
			...
			SDKVersion:        "0.0.1",
			GenVersion:        "2.384.4",
			UserAgent:         "speakeasy-sdk/go 0.0.1 2.384.4 2.0.0 github.com/antonbabenko/terraform-provider-openai/v2/internal/sdk",
			Hooks:             hooks.New(),
		},
	}
