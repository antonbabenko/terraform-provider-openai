...
type _CreateTranscriptionRequest CreateTranscriptionRequest

func (c *CreateTranscriptionRequest) UnmarshalJSON(bs []byte) error {
	data := _CreateTranscriptionRequest{}

	if err := json.Unmarshal(bs, &data); err != nil {
		return err
	}
	*c = CreateTranscriptionRequest(data)
...
func (c CreateTranscriptionRequest) MarshalJSON() ([]byte, error) {
	...
	bs, err := json.Marshal(_CreateTranscriptionRequest(c))
	if err != nil {
		return nil, err
	}
